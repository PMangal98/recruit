...
<body>
    ...
    <div class= "profile-div" >
        ...
        <hr>
        <form class="cd-body col" action="postJob.php" method="POST">
        
            <div class="form-group">
                <label for ="job_type">Job Type: </label>
                <input type="text" class="form-control bottom-margin-forms" id="job_type" placeholder=" Job_type " name="job_type" required>
                <div class="row">                
                    <div class="col-6">                    
                        <label for ="start_date">Start date: </label>
                        <input type="date" class="form-control bottom-margin-forms" id="start_date" name="start_date" required>
                    </div>
                    <div class="col-6">                    
                        <label for ="end_date">End date: </label>
                        <input type="date" class="form-control bottom-margin-forms" id="end_date" name="end_date" required>                    
                    </div>                
                </div>
                <label for ="salary">Salary: </label>
                <input type="text" class="form-control bottom-margin-forms" id="salary" placeholder=" Salary in rupees " name="salary" required>
                <label for ="location">Location: </label>
                <input type="text" class="form-control bottom-margin-forms" id="location" placeholder="Location" name="location" required>
                <label > Skills required: </label>
                <div class="row">                
                    <div class="col-6">                    
                        <input type="text" class="form-control bottom-margin-forms" id="skill1" name="skill1" placeholder="Skill 1">
                        <input type="hidden" id="skill1Id" name="skill1Id" >
                    </div>
                    <div class="col-6">
                ...
                <div class="row">                
                    <div class="col-6">                    
                        ...
                        <input type="hidden" id="skill2Id" name="skill2Id">
                    </div>
                    <div class="col-6">
                ...
                <div class="row">                
                    <div class="col-6">                    
                        ...
                        <input type="hidden" id="skill3Id" name="skill3Id">
                    </div>
                    <div class="col-6">
                ...
                <div class="row">                
                    <div class="col-6">                    
                        ...
                        <input type="hidden" id="skill4Id" name="skill4Id" >
                    </div>
                    <div class="col-6">
                ...
                <div class="row">                
                    <div class="col-6">                    
                        ...
                        <input type="hidden" id="skill5Id" name="skill5Id">
                    </div>
                    <div class="col-6">
    ...
    $(document).ready(function(){
        ...
        $("#skill1").autocomplete({
            ...
            select: function(event,ui){
                $("#skill1Id").val(ui.item.id);
            }
        });
         $("#skill2").autocomplete({
            source: 'FetchSkills.php',
            select: function(event,ui){
                $("#skill2Id").val(ui.item.id);
            }
        });
        $("#skill3").autocomplete({
            source: 'FetchSkills.php',
            select: function(event,ui){
                $("#skill3Id").val(ui.item.id);
            }
        });
        $("#skill4").autocomplete({
            source: 'FetchSkills.php',
            select: function(event,ui){
                $("#skill4Id").val(ui.item.id);
            }
        });
        $("#skill5").autocomplete({
            source: 'FetchSkills.php',
            select: function(event,ui){
                $("#skill5Id").val(ui.item.id);
            }
        });

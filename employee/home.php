...
<body>
    ...
    <nav class = "navbar navbar-expand-md navbar-dark bg-primary">
        ...
        <div class = "collapse navbar-collapse" id = "navbarNav">
            ...
            <ul class = "navbar-nav">
                ...
                <li class = "nav-item">
                    <a class = "nav-link" href = "./applications.php">Applied</a>
                </li>
                <li class = "nav-item">
    ...
    <div class= "profile-div" >
        ...
        <div class="cd-header"> Personal Info </div>
        <hr>
        <div class="cd-body col">
            ...
            <div class="row">
                ...
                <div class="sml-ans col-8"> 
                     <?php echo htmlspecialchars($row['emplName']) ?> 
                </div>
            </div>
            <div class="row">
    ...
    <div class= "profile-div" >
        ...
        <div class="cd-header"> Educational Info: </div>
        <hr>
        <div class="cd-body col">
            <?php
                $eeUserId = $_SESSION['userId'];
                $errors = array();
    ...
    <div class= "profile-div" >
        ...
        <div class="cd-header"> Experience: </div>
        <hr>
        <div class="cd-body col">
            <?php
    ...
    <div class= "profile-div" >
        ...
        <div class="cd-header"> Skills: </div>
        <hr>
        <div class="cd-body col">
            <?php
                $subquery_ex = "SELECT skill_name from skill inner join experienceskill on experienceskill.skill_id = skill.skill_id inner join experience on experience.exp_id = experienceskill.exp_id and experience.employee_id = {$eeUserId}";
                $runQuery1_ex = mysqli_query($dbcon, $subquery_ex);
                while($ex_row = mysqli_fetch_assoc($runQuery1_ex)){
                    echo 
                    '
                    <div class="exp-fields">
                    <b>'.$ex_row["skill_name"].'</b><br>
                    </div>
                    ';
                }
            ?>      
